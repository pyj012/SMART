...
while True:
    ...
    # client.loop_forever()
    # client.disconnect()
    send_value ={0x31:value,0x32:value,0x33:value,0x34:value,0x36:value,0x37:value,0x38:value,0x39:value,0x3A:value,0x3C:value}
    client.publish('robot',json.dumps(send_value),1)
    if flag :
        value += 5  
        if value>=365:
            flag=0
