...
if __name__ == '__main__':
    ...
    write_keypoints_to_disk('kpts_cam0_AddDot.dat', kpts_cam0)
    write_keypoints_to_disk('kpts_cam1_AddDot.dat', kpts_cam1)
    write_keypoints_to_disk('kpts_3d_AddDot.dat', kpts_3d)