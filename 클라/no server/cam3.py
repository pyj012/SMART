...
def visualize_3d(ax, p3ds):
    ...
    for bodypart, part_color in zip(body, colors):
        for _c in bodypart:
            ax.plot(xs=[p3ds[_c[0], 0], p3ds[_c[1], 0]], ys=[p3ds[_c[0], 1], p3ds[_c[1], 1]], zs=[p3ds[_c[0], 2], p3ds[_c[1], 2]], linewidth=4, c=part_color)
...
if __name__ == '__main__':
    input_streams = [0, 1, 2]  # Default to three cameras

    if len(sys.argv) == 4:
        input_streams = [int(arg) for arg in sys.argv[1:4]]
