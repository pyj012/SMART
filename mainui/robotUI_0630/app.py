...
class MainApplication(QWidget):
    def __init__(self):
        ...
        self.lpf1 = LowPassFilter(0.05, 0.05)
        self.lpf2 = LowPassFilter(0.05, 0.05)
        self.lpf3 = LowPassFilter(0.05, 0.05)
        self.lpf4 = LowPassFilter(0.05, 0.05)
        self.lpf5 = LowPassFilter(0.05, 0.05)
        self.lpf6 = LowPassFilter(0.05, 0.05)
        self.lpf1_check =0
        self.lpf2_check =0
        self.lpf3_check =0
        self.lpf4_check =0
