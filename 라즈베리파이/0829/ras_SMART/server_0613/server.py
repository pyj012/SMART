...
class SocketServer():
    def __init__(self):
        ...
        self.times =  0
        self.prevTime = 0
        self.motorAngles={0x31:125, 0x32:0, 0x33:0, 0x34:0, 0x35:125, 0x36:0, 0x37:0, 0x38:0, 0x39:0}
        ...
        self.debugthread = threading.Thread(target= self._send_dynamix, args=())
    ...
    def _send_dynamix(self):
        ...
        while(1):
            try:
                ...
                ids = list(self.motorAngles.keys())
                values = list(self.motorAngles.values())
